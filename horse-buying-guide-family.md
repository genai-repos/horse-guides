...
- **Ranch Conformation**: Cowboying horses with balanced, sturdy builds (common in **Driftwood** or **Hancock** lines) are suitable for “Form-to-Function” judging, requiring no additional training if conformation is sound.
...
|------|------------|--------------------------|----------------------------------------|----------|---------------------|
| Shining Spark | Reining precision, cow sense, versatility | Exceptional in herd/rein/cow work | Strong in all events, especially reining/cutting | Suitable with training | Limited, high-energy unless extensively trained |
| High Brow Cat | Intense cow sense, cutting ability, agility | Dominant in herd/cow work | Suitable for cutting/cow work | Suitable for cattle work | Limited, high-energy unless extensively trained |
| Peppy San Badger | Cow sense, durability, ranch work suitability, trainable temperament | Strong in all events | Excels in all events, especially cow work | Excellent for all ranch tasks | Suitable in ranch-bred lines, calm for trail/lessons |
| Colonel Freckles | Cow sense, reining ability, trainability | Strong in herd/rein/cow work | Versatile across all events | Suitable for cattle/roping | Limited, needs calm individuals for kids |
| Playgun | Cow sense, versatility, athleticism | Suitable for herd/cow work | Exceptional in cutting/cow work/riding | Suitable for cattle/roping | Limited, high-energy unless extensively trained |
| Not Ruf At All | Reining prowess, cow sense, modern performance | Exceptional in rein/cow work | Suitable for reining/cow work | Limited, needs training | Not suitable, too performance-focused |
| Paddys Irish Whiskey | Versatility, smooth gaits, ranch work suitability, easy-going temperament | Suitable for all events | Excels in riding/trail/cow work | Strong for riding/chores | Suitable, calm for trail/lessons |
| Driftwood | Cow sense, endurance, toughness, steady temperament | Suitable with training | Strong with training, especially cutting | Excellent for roping/doctoring | Suitable, reliable for trail/light tasks when mature |
| Hancock | Ruggedness, stamina, cow sense, calm temperament | Suitable with training | Strong with training, especially cow work | Excellent for all ranch tasks | Suitable, dependable for trail when trained |
| Two Eyed Jack | Versatility, calm temperament, roping ability | Suitable with training | Strong in riding/cow work/roping | Excellent for roping/doctoring | Highly suitable, gentle for trail/lessons |

## Recommendations for Buyers
- **Test the Horse**: Ensure the horse can perform required maneuvers (e.g., reining patterns for NRCHA/VRH, cow work for all disciplines, roping/doctoring for cowboying). Work with a trainer to evaluate suitability.
- **Pedigree Check**: Verify bloodlines for cow sense and versatility (e.g., Shining Spark, Peppy San Badger, Driftwood). Prioritize sires with proven performance in the desired discipline.
- **Budget**: Well-trained NRCHA/VRH horses with show experience may cost $15,000–$50,000+, while ranch-bred cowboying horses or younger VRH horses range from $5,000–$15,000. Family-friendly horses typically fall in the $5,000–$15,000 range.
- **Location**: Focus on regions like Texas, Kansas, New Mexico, Arizona, or Montana, where ranch horse breeding is prominent.
- **Divisions**: For beginners, consider Novice or Limited divisions in VRH or ranch-bred horses for cowboying, requiring less specialized skills. Experienced riders should seek horses with show or work records.
- **Family Use**: For kids, prioritize mature (8–15 years) AQHA geldings with **Two Eyed Jack**, **Peppy San Badger**, or **Driftwood** bloodlines, tested for kid-friendliness and extensive handling.
...
| **Conformation** | Compact, muscular, strong hindquarters, good bone | Balanced, structurally correct, adequate muscling, strong feet | Stocky, strong-boned, robust hindquarters, sturdy feet | Balanced, sturdy, preferably 14.2–15.2 hands |
| **Height** | 14.2–15.2 hands | 14.3–15.3 hands | 14.3–15.3 hands | 14.2–15.2 hands, smaller sizes easier for kids |
| **Athleticism** | High agility for spins, slides, fence work; quick-footed for herd work | Quick for reining/cow work, smooth-gaited for ranch riding | Agile for cattle handling/roping, steady for long rides | Steady, gentle for trail/light tasks |
| **Temperament** | Calm, responsive, strong cow sense, composed under pressure | Calm, willing, trainable, can “turn off” intensity for trail/riding | Calm, steady, willing, strong cow sense | Exceptionally calm, patient, forgiving, “babysitter” disposition |
| **Training/Skills** | Reining patterns, cow work (boxing, fencing, circling), herd work | Reining, cow work (boxing, some fencing), cutting, trail obstacles, smooth gaits, conformation judging | Basic cattle work (herding, sorting, holding), ranch roping, doctoring, terrain navigation | Well-broke, desensitized, reliable for novice riders |
| **Preferences** | Geldings for consistency; mares with good temperament; NRCHA experience | All-around ability; geldings or mares; AQHA VRH/SHTX experience | Geldings for steady temperament; mares if calm; ranch experience | Mature geldings (8–15 years), extensively handled |

### Table 2: Best Places to Look for Buying Horses
| Source | Description | Best For | Location/Contact |
|--------|-------------|----------|------------------|
| Ranch World Ads | Online classifieds for ranch/performance horses (AQHA, APHA, cow horses). | All disciplines | [https://www.ranchworldads.com](https://www.ranchworldads.com) |
| Flint Creek Quarter Horses | Montana breeder specializing in AQHA ranch, rope, and cow horses; versatile geldings for cowboying, VRH, and some NRCHA tasks. | Cowboying, Versatility Ranch Horse, some Reined Cow Horse | [https://flintcreekquarterhorses.com](https://flintcreekquarterhorses.com), 406-544-9987 |
| Perry Quarter Horses | Kansas breeder specializing in Reined Cow Horse, Versatility Ranch Horse, and cowboying AQHA horses. | All disciplines | [https://www.perryquarterhorses.com](https://www.perryquarterhorses.com) |
| Boyd Ranch, LLC | New Mexico ranch breeding/selling cow and ranch horses. | All disciplines | [https://www.boydranch.net](https://www.boydranch.net) |
| King Ranch | Texas breeder of AQHA horses with top bloodlines (e.g., Peppy San Badger, Driftwood). | Versatility Ranch Horse, Cowboying, some Reined Cow | [https://king-ranch.com](https://king-ranch.com) |
| Bar TT Cowhorse | Alberta/Arizona breeder/trainer of AQHA Reined Cow Horses, some suited for Versatility and cowboying. | Reined Cow Horse, some Versatility/Cowboying | [https://www.bar-tt-cowhorse.com](https://www.bar-tt-cowhorse.com) |
| eHorses | Online marketplace with verified ads for Versatility Ranch Horses and ranch-bred horses (AQHA, APHA). | Versatility Ranch Horse, Cowboying | [https://www.ehorses.com](https://www.ehorses.com) |
| AQHA/NRCHA Events | Network at NRCHA shows or AQHA VRH World Championships for word-of-mouth sales. | All disciplines | [https://www.nrcha.com](https://www.nrcha.com), [https://www.aqha.com](https://www.aqha.com) |
| Stock Horse of Texas | Texas events/network for finding ranch horses through breeders/riders. | Versatility Ranch Horse, Cowboying | [https://stockhorsetexas.org](https://stockhorsetexas.org) |
| Return to the Remuda Sale | Annual sale at King Ranch for top-tier horses with Peppy San Badger, Driftwood lines. | All disciplines | [https://king-ranch.com](https://king-ranch.com) |
| Turner Performance Horses | Montana/Arizona breeder offering AQHA and APHA performance horses for all disciplines, with show-proven records. | All disciplines | [https://turnerperformancehorses.com](https://turnerperformancehorses.com), 406-381-2347 |
| Reverse 53 Horses | Texas breeder of AQHA ranch horses with foundation bloodlines, suitable for cowboying and VRH. | Cowboying, Versatility Ranch Horse | [https://www.reverse53horses.com](https://www.reverse53horses.com), contact via website |
| Legacy Ranch Horse Sale | Annual sale in Prescott, Arizona, offering AQHA horses from K4 Ranches and Diamond A Ranch, suitable for cowboying, VRH, and family use with kids. | Cowboying, Versatility Ranch Horse, some Reined Cow Horse, Family Use | [https://www.ranchhorsesale.com](https://www.ranchhorsesale.com), 520-360-9524 |
| High Plains Ranchers & Breeders Association (HPRBA) | Annual sale in Amarillo, Texas, offering AQHA horses with Peppy San Badger, Driftwood lines, suitable for cowboying, VRH, and family use with careful selection. | Cowboying, Versatility Ranch Horse, some Reined Cow Horse, Family Use | [https://www.hprba.com](https://www.hprba.com), 806-674-7337 |
